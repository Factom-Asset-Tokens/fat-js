...
function checkVersionCompatibility(version) {
    ...
    if (semver.lt(version, '0.4.2')) console.warn('WARNING: You are using a version of fatd(', version, ') with known RPC bugs. Unexpected or inconsistent behavior may occur');
    ...
    if (semver.gt(version, '0.4.2')) console.warn('WARNING: You are using a newer version of fatd(', version, ') than this fat-js version was tested with. Some data structures and API behavior may not be forwards compatible');
}
